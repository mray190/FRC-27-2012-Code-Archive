...
KeepAliveTimeout 60
		...
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="AutonCSV.vi" Type="VI" URL="../AutonCSV.vi"/>
			<Item Name="Determine Bounds.vi" Type="VI" URL="../Determine Bounds.vi"/>
			<Item Name="MidpointCalculate.vi" Type="VI" URL="../MidpointCalculate.vi"/>
			<Item Name="Pasco Drive Correcting.vi" Type="VI" URL="../Pasco Drive Correcting.vi"/>
			<Item Name="Ramp Actuator Speed.vi" Type="VI" URL="../Ramp Actuator Speed.vi"/>
			<Item Name="S1-S2-SenseBall.vi" Type="VI" URL="../S1-S2-SenseBall.vi"/>
			<Item Name="S3-SenseBall.vi" Type="VI" URL="../S3-SenseBall.vi"/>
			<Item Name="BallSequencing.vi" Type="VI" URL="../BallSequencing.vi"/>
			<Item Name="MRay Auton.vi" Type="VI" URL="../MRay Auton.vi"/>
			<Item Name="unpackAutonArrayMRay.vi" Type="VI" URL="../unpackAutonArrayMRay.vi"/>
			<Item Name="CalculateOffsetMRay.vi" Type="VI" URL="../CalculateOffsetMRay.vi"/>
			<Item Name="MRayBallTracking.vi" Type="VI" URL="../MRayBallTracking.vi"/>
			<Item Name="MRayScoreParticles.vi" Type="VI" URL="../MRayScoreParticles.vi"/>
			<Item Name="MRayComputeDistance.vi" Type="VI" URL="../MRayComputeDistance.vi"/>
			<Item Name="Finish.vi" Type="VI" URL="../Finish.vi"/>
			<Item Name="MRayTurretHome.vi" Type="VI" URL="../MRayTurretHome.vi"/>
		</Item>
		<Item Name="Vision Support Code" Type="Folder">
			...
			<Item Name="MRay Calculate Vision.vi" Type="VI" URL="../MRay Calculate Vision.vi"/>
		</Item>
		<Item Name="Support Code" Type="Folder">
			<Item Name="Read Joystick 1.vi" Type="VI" URL="../Read Joystick 1.vi"/>
			<Item Name="Read Joystick 2.vi" Type="VI" URL="../Read Joystick 2.vi"/>
			<Item Name="Read Joystick 3.vi" Type="VI" URL="../Read Joystick 3.vi"/>
			<Item Name="Read Joystick 4.vi" Type="VI" URL="../Read Joystick 4.vi"/>
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Elapsed Times.vi"/>
			<Item Name="Get Robot Competition Mode.vi" Type="VI" URL="../Get Robot Competition Mode.vi"/>
			<Item Name="Turret Structure.vi" Type="VI" URL="../Turret Structure.vi"/>
		</Item>
		<Item Name="Robot Main.vi" Type="VI" URL="../Robot Main.vi"/>
		<Item Name="AutonInit.vi" Type="VI" URL="../AutonInit.vi"/>
		<Item Name="AutonSwitchFile.vi" Type="VI" URL="../AutonSwitchFile.vi"/>
		<Item Name="GyroInit.vi" Type="VI" URL="../GyroInit.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Pasco Excel Write.vi" Type="VI" URL="../Pasco Excel Write.vi"/>
			<Item Name="Pasco Auton Pack.vi" Type="VI" URL="../Pasco Auton Pack.vi"/>
			<Item Name="RUSHKinectCalibrate.vi" Type="VI" URL="../RUSHKinectCalibrate.vi"/>
			<Item Name="KINECTAverage.vi" Type="VI" URL="../KINECTAverage.vi"/>
			<Item Name="KINECTZ_Axis_To_Motor_Convert_Punch.vi" Type="VI" URL="../KINECTZ_Axis_To_Motor_Convert_Punch.vi"/>
			<Item Name="KINECTCalibrate.vi" Type="VI" URL="../KINECTCalibrate.vi"/>
			<Item Name="KINECTcheckMusclesAngle.vi" Type="VI" URL="../KINECTcheckMusclesAngle.vi"/>
			<Item Name="KINECTMuscleFull.vi" Type="VI" URL="../KINECTMuscleFull.vi"/>
			<Item Name="KINECTDeadband.vi" Type="VI" URL="../KINECTDeadband.vi"/>
			<Item Name="KINECTAngleConvertYZ.vi" Type="VI" URL="../KINECTAngleConvertYZ.vi"/>
			<Item Name="KINECTAngleConvertXY.vi" Type="VI" URL="../KINECTAngleConvertXY.vi"/>
			<Item Name="KINECTGestureProcessing.vi" Type="VI" URL="../KINECTGestureProcessing.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="TeamRUSH27" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Bld_buildSpecName" Type="Str">TeamRUSH27</Property>
				...
				<Property Name="RTExe_localDestPath" Type="Path">../2012 Robot Code 1-21-12/Builds</Property>
				<Property Name="Source[0].itemID" Type="Str">{AB75B688-A3CA-45D8-B2BC-5B904CFC4F70}</Property>
