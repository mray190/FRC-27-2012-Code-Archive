...
<Project Type="Project" LVVersion="11008008">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="dashboard" Type="Folder">
			<Item Name="Build Camera IP.vi" Type="VI" URL="../dashboard/Build Camera IP.vi"/>
			...
			<Item Name="dashboard_ack_packet.ctl" Type="VI" URL="../dashboard/dashboard_ack_packet.ctl"/>
			<Item Name="dashboard_return_data.ctl" Type="VI" URL="../dashboard/dashboard_return_data.ctl"/>
			<Item Name="dashboard_UDP_Transaction.vi" Type="VI" URL="../dashboard/dashboard_UDP_Transaction.vi"/>
			<Item Name="dashboard_vision_processing.vi" Type="VI" URL="../dashboard/dashboard_vision_processing.vi"/>
			...
			<Item Name="DStoPCPacketTypeDef.ctl" Type="VI" URL="../dashboard/DStoPCPacketTypeDef.ctl"/>
			<Item Name="Elapsed Time.vi" Type="VI" URL="../dashboard/Elapsed Time.vi"/>
			...
			<Item Name="Update Battery Indicator.vi" Type="VI" URL="../dashboard/Update Battery Indicator.vi"/>
		</Item>
		<Item Name="test_vision.vi" Type="VI" URL="../2012vision/test_vision.vi"/>
		<Item Name="test_image_resize.vi" Type="VI" URL="../2012vision/test_image_resize.vi"/>
		...
		<Item Name="Camera Data State.ctl" Type="VI" URL="../2012vision/Camera Data State.ctl"/>
		<Item Name="SignalTest.vi" Type="VI" URL="../signals/SignalTest.vi"/>
		<Item Name="Test Target Angle Correction.vi" Type="VI" URL="../2012vision/Test Target Angle Correction.vi"/>
		<Item Name="gun_speed_test_feed_forward.vi" Type="VI" URL="../gun/gun_speed_test_feed_forward.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="boolean_trigger.vi" Type="VI" URL="../common/boolean_trigger.vi"/>
			<Item Name="Signal.ctl" Type="VI" URL="../signals/Signal.ctl"/>
			<Item Name="SignalAction.ctl" Type="VI" URL="../signals/SignalAction.ctl"/>
			<Item Name="SignalManager.vi" Type="VI" URL="../signals/SignalManager.vi"/>
			<Item Name="SendSignal.vi" Type="VI" URL="../signals/SendSignal.vi"/>
			<Item Name="SignalTrap.vi" Type="VI" URL="../signals/SignalTrap.vi"/>
			<Item Name="gun_motor_state.ctl" Type="VI" URL="../gun/gun_motor_state.ctl"/>
			<Item Name="gun_speed_feed_forward.vi" Type="VI" URL="../gun/gun_speed_feed_forward.vi"/>
			<Item Name="gun_tracking_mode.ctl" Type="VI" URL="../gun/gun_tracking_mode.ctl"/>
			<Item Name="dashboard_data_gun_fast.ctl" Type="VI" URL="../dashboard/dashboard_data_gun_fast.ctl"/>
			...
			<Item Name="dashboard_data_drivetrain.ctl" Type="VI" URL="../dashboard/dashboard_data_drivetrain.ctl"/>
			...
			<Item Name="dashboard_logger.vi" Type="VI" URL="../dashboard/dashboard_logger.vi"/>
			<Item Name="logger_data.vi" Type="VI" URL="../dashboard/logger_data.vi"/>
			<Item Name="dashboard_globals.vi" Type="VI" URL="../dashboard/dashboard_globals.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
	<Item Name="RT CompactRIO Target" Type="RT CompactRIO">
		<Property Name="alias.name" Type="Str">RT CompactRIO Target</Property>
		<Property Name="alias.value" Type="Str">10.00.33.2</Property>
...
KeepAliveTimeout 60
		...
		<Item Name="System" Type="Folder">
			...
			<Item Name="HMI.vi" Type="VI" URL="../HMI/HMI.vi"/>
		</Item>
		<Item Name="Drivetrain" Type="Folder">
			<Item Name="drivetrain.vi" Type="VI" URL="../drivetrain/drivetrain.vi"/>
			<Item Name="drivetrain_get_encoders.vi" Type="VI" URL="../drivetrain/drivetrain_get_encoders.vi"/>
			<Item Name="drivetrain_drive_pair_t.ctl" Type="VI" URL="../drivetrain/drivetrain_drive_pair_t.ctl"/>
			<Item Name="gear_shift_state.ctl" Type="VI" URL="../drivetrain/gear_shift_state.ctl"/>
			<Item Name="drivetrain_shift_state_store.vi" Type="VI" URL="../drivetrain/drivetrain_shift_state_store.vi"/>
			<Item Name="drivetrain_globals.vi" Type="VI" URL="../drivetrain/drivetrain_globals.vi"/>
			<Item Name="drivetrain_drive_speed_store.vi" Type="VI" URL="../drivetrain/drivetrain_drive_speed_store.vi"/>
			<Item Name="drivetrain_drive_mode.ctl" Type="VI" URL="../drivetrain/drivetrain_drive_mode.ctl"/>
			<Item Name="drivetrain_create.vi" Type="VI" URL="../drivetrain/drivetrain_create.vi"/>
			<Item Name="drivetrain_raw_to_ftsec.vi" Type="VI" URL="../drivetrain/drivetrain_raw_to_ftsec.vi"/>
			<Item Name="drivetrain_ftsec_to_raw.vi" Type="VI" URL="../drivetrain/drivetrain_ftsec_to_raw.vi"/>
			<Item Name="drivetrain_drive_write_thread.ctl" Type="VI" URL="../drivetrain/drivetrain_drive_write_thread.ctl"/>
			<Item Name="drivetrain_reset_encoders.vi" Type="VI" URL="../drivetrain/drivetrain_reset_encoders.vi"/>
			<Item Name="gear_internal_shift_state.ctl" Type="VI" URL="../drivetrain/gear_internal_shift_state.ctl"/>
			<Item Name="drivetrain_ftsec_to_raw_real.vi" Type="VI" URL="../drivetrain/drivetrain_ftsec_to_raw_real.vi"/>
		</Item>
		<Item Name="common" Type="Folder">
			<Item Name="idg_trust_t.ctl" Type="VI" URL="../idg_trust_t.ctl"/>
			<Item Name="data_store_mode_t.ctl" Type="VI" URL="../data_store_mode_t.ctl"/>
			<Item Name="simple_analog_scale.vi" Type="VI" URL="../common/simple_analog_scale.vi"/>
			<Item Name="has_state_changed.vi" Type="VI" URL="../common/has_state_changed.vi"/>
			<Item Name="gun_idg_const.ctl" Type="VI" URL="../gun/gun_idg_const.ctl"/>
			<Item Name="gain_const.ctl" Type="VI" URL="../common/gain_const.ctl"/>
			<Item Name="scale_const.ctl" Type="VI" URL="../common/scale_const.ctl"/>
			<Item Name="simple_PID_controller.vi" Type="VI" URL="../common/simple_PID_controller.vi"/>
			<Item Name="analog_input_diagnostics.vi" Type="VI" URL="../common/analog_input_diagnostics.vi"/>
			<Item Name="limit_pct.vi" Type="VI" URL="../common/limit_pct.vi"/>
			<Item Name="victor_linearize.vi" Type="VI" URL="../common/victor_linearize.vi"/>
			<Item Name="ds_error_handler.vi" Type="VI" URL="../common/ds_error_handler.vi"/>
			<Item Name="error_codes.ctl" Type="VI" URL="../common/error_codes.ctl"/>
			<Item Name="error_states.vi" Type="VI" URL="../common/error_states.vi"/>
			<Item Name="boolean_trigger.vi" Type="VI" URL="../common/boolean_trigger.vi"/>
			<Item Name="simple_gain_scheduler.vi" Type="VI" URL="../common/simple_gain_scheduler.vi"/>
			<Item Name="limit_deadband.vi" Type="VI" URL="../common/limit_deadband.vi"/>
			<Item Name="Robot Ctl.ctl" Type="VI" URL="../Robot Ctl.ctl"/>
			<Item Name="idg_trust_persuader.vi" Type="VI" URL="../common/idg_trust_persuader.vi"/>
			<Item Name="SimpleSetMotor.vi" Type="VI" URL="../WPI_mods/SimpleSetMotor.vi"/>
			<Item Name="nancheck.vi" Type="VI" URL="../common/nancheck.vi"/>
			<Item Name="low_cap.vi" Type="VI" URL="../common/low_cap.vi"/>
			<Item Name="gain_bin_sched_const.ctl" Type="VI" URL="../common/gain_bin_sched_const.ctl"/>
			<Item Name="binary_gain_scheduler.vi" Type="VI" URL="../common/binary_gain_scheduler.vi"/>
			<Item Name="dashboard_data_gun_slow_down.ctl" Type="VI" URL="../dashboard/dashboard_data_gun_slow_down.ctl"/>
			<Item Name="dashboard_data_store.vi" Type="VI" URL="../dashboard/dashboard_data_store.vi"/>
			<Item Name="dashboard_data_drivetrain.ctl" Type="VI" URL="../dashboard/dashboard_data_drivetrain.ctl"/>
			<Item Name="dashboard_data_roller.ctl" Type="VI" URL="../dashboard/dashboard_data_roller.ctl"/>
			<Item Name="dashboard_data.ctl" Type="VI" URL="../dashboard/dashboard_data.ctl"/>
			<Item Name="dashboard_data_gun_fast.ctl" Type="VI" URL="../dashboard/dashboard_data_gun_fast.ctl"/>
			<Item Name="linear_ramp.vi" Type="VI" URL="../common/linear_ramp.vi"/>
			<Item Name="dashboard_data_joe_johnson.ctl" Type="VI" URL="../dashboard/dashboard_data_joe_johnson.ctl"/>
			<Item Name="rate_limit.vi" Type="VI" URL="../script/scriptlib/rate_limit.vi"/>
		</Item>
		<Item Name="vision" Type="Folder">
			...
			<Item Name="Map To Direction.vi" Type="VI" URL="../2012vision/Map To Direction.vi"/>
			<Item Name="Find Lines.vi" Type="VI" URL="../2012vision/Find Lines.vi"/>
			<Item Name="Find Diamonds.vi" Type="VI" URL="../2012vision/Find Diamonds.vi"/>
			<Item Name="Vision Instrumentation Control.ctl" Type="VI" URL="../2012vision/Vision Instrumentation Control.ctl"/>
			<Item Name="Diamond Target Analysis.vi" Type="VI" URL="../2012vision/Diamond Target Analysis.vi"/>
			<Item Name="Target Confidence.ctl" Type="VI" URL="../2012vision/Target Confidence.ctl"/>
			<Item Name="Targetting Output.ctl" Type="VI" URL="../2012vision/Targetting Output.ctl"/>
			<Item Name="Vision Processing.vi" Type="VI" URL="../2012vision/Vision Processing.vi"/>
			<Item Name="Draw Rectangle Helper.vi" Type="VI" URL="../2012vision/Draw Rectangle Helper.vi"/>
			<Item Name="Multiple Target Analysis.vi" Type="VI" URL="../2012vision/Multiple Target Analysis.vi"/>
			<Item Name="Camera State.ctl" Type="VI" URL="../2012vision/Camera State.ctl"/>
			<Item Name="Filter Outliers.vi" Type="VI" URL="../2012vision/Filter Outliers.vi"/>
			<Item Name="Diamond Target Output.ctl" Type="VI" URL="../2012vision/Diamond Target Output.ctl"/>
			<Item Name="Target.ctl" Type="VI" URL="../2012vision/Target.ctl"/>
			<Item Name="Line.ctl" Type="VI" URL="../2012vision/Line.ctl"/>
			<Item Name="Line Confidence.ctl" Type="VI" URL="../2012vision/Line Confidence.ctl"/>
			<Item Name="Rectangle Position.ctl" Type="VI" URL="../2012vision/Rectangle Position.ctl"/>
			<Item Name="test_victor_linearize.vi" Type="VI" URL="../common/test_victor_linearize.vi"/>
			<Item Name="Camera Manager.vi" Type="VI" URL="../2012vision/Camera Manager.vi"/>
			<Item Name="UDP_robot.vi" Type="VI" URL="../UDP/UDP_robot.vi"/>
			<Item Name="Store Targetting Output.vi" Type="VI" URL="../2012vision/Store Targetting Output.vi"/>
			<Item Name="robot_UDP_Transaction.vi" Type="VI" URL="../dashboard/robot_UDP_Transaction.vi"/>
		</Item>
		<Item Name="joe johnson" Type="Folder">
			<Item Name="joe_johnson.vi" Type="VI" URL="../joe_johnson/joe_johnson.vi"/>
			<Item Name="joe_johnson_const.vi" Type="VI" URL="../joe_johnson/joe_johnson_const.vi"/>
			<Item Name="joe_johnson_const_t.ctl" Type="VI" URL="../joe_johnson/joe_johnson_const_t.ctl"/>
			<Item Name="joe_johnson_state.ctl" Type="VI" URL="../joe_johnson/joe_johnson_state.ctl"/>
			<Item Name="joe_johnson_state_store.vi" Type="VI" URL="../joe_johnson/joe_johnson_state_store.vi"/>
			<Item Name="joe_johnson_state_setpoints.vi" Type="VI" URL="../joe_johnson/joe_johnson_state_setpoints.vi"/>
			<Item Name="peg_leg_state.ctl" Type="VI" URL="../joe_johnson/peg_leg_state.ctl"/>
			<Item Name="peg_leg_state_store.vi" Type="VI" URL="../joe_johnson/peg_leg_state_store.vi"/>
			<Item Name="peg_leg_state_setpoints.vi" Type="VI" URL="../joe_johnson/peg_leg_state_setpoints.vi"/>
			<Item Name="joe_johnson_create.vi" Type="VI" URL="../joe_johnson/joe_johnson_create.vi"/>
			<Item Name="joe_johnson_map_button_to_state.vi" Type="VI" URL="../joe_johnson/joe_johnson_map_button_to_state.vi"/>
			<Item Name="peg_leg_map_button_to_state.vi" Type="VI" URL="../joe_johnson/peg_leg_map_button_to_state.vi"/>
			<Item Name="joe_johnson_manual_store.vi" Type="VI" URL="../joe_johnson/joe_johnson_manual_store.vi"/>
			<Item Name="peg_leg_manual_store.vi" Type="VI" URL="../joe_johnson/peg_leg_manual_store.vi"/>
		</Item>
		<Item Name="script" Type="Folder">
			<Item Name="Auto_Conf.vi" Type="VI" URL="../script/Auto_Conf.vi"/>
			<Item Name="Auto_Initialization.vi" Type="VI" URL="../script/Auto_Initialization.vi"/>
			<Item Name="Autonomous_Thread.vi" Type="VI" URL="../script/Autonomous_Thread.vi"/>
			<Item Name="CreateCommands.vi" Type="VI" URL="../script/CreateCommands.vi"/>
			<Item Name="ExecuteCommand.vi" Type="VI" URL="../script/ExecuteCommand.vi"/>
			<Item Name="ExecuteFile.vi" Type="VI" URL="../script/ExecuteFile.vi"/>
			<Item Name="GetSetCommandsPointers.vi" Type="VI" URL="../script/GetSetCommandsPointers.vi"/>
			<Item Name="LookupCommandPointer.vi" Type="VI" URL="../script/LookupCommandPointer.vi"/>
			<Item Name="ProcessControlCharacters.vi" Type="VI" URL="../script/ProcessControlCharacters.vi"/>
			<Item Name="read_auto_file.vi" Type="VI" URL="../script/read_auto_file.vi"/>
			<Item Name="RegisterCommandPointer.vi" Type="VI" URL="../script/RegisterCommandPointer.vi"/>
			<Item Name="tokenize_to_array.vi" Type="VI" URL="../script/tokenize_to_array.vi"/>
			<Item Name="WriteDebugLine.vi" Type="VI" URL="../script/WriteDebugLine.vi"/>
			<Item Name="ScriptEngineMutex.vi" Type="VI" URL="../script/ScriptEngineMutex.vi"/>
			<Item Name="MutexMode.ctl" Type="VI" URL="../script/MutexMode.ctl"/>
			<Item Name="MutexState.ctl" Type="VI" URL="../script/MutexState.ctl"/>
			<Item Name="AsynchronousScriptHelper.vi" Type="VI" URL="../script/AsynchronousScriptHelper.vi"/>
			<Item Name="AsynchronousScriptName.vi" Type="VI" URL="../script/AsynchronousScriptName.vi"/>
			<Item Name="ScriptButton.vi" Type="VI" URL="../script/ScriptButton.vi"/>
			<Item Name="ExecuteCommand2.vi" Type="VI" URL="../script/ExecuteCommand2.vi"/>
			<Item Name="StringComparison.vi" Type="VI" URL="../script/StringComparison.vi"/>
			<Item Name="WhenAsynchronousHelper.vi" Type="VI" URL="../script/WhenAsynchronousHelper.vi"/>
			<Item Name="VariableStorage.vi" Type="VI" URL="../script/VariableStorage.vi"/>
		</Item>
		<Item Name="HMI" Type="Folder">
			<Item Name="user_data.ctl" Type="VI" URL="../HMI/user_data.ctl"/>
			<Item Name="hmi_get_joystick_data.vi" Type="VI" URL="../HMI/hmi_get_joystick_data.vi"/>
			<Item Name="user_buttons.ctl" Type="VI" URL="../HMI/user_buttons.ctl"/>
			<Item Name="user_buttons_360.ctl" Type="VI" URL="../HMI/user_buttons_360.ctl"/>
			<Item Name="user_buttons_dualaction.ctl" Type="VI" URL="../HMI/user_buttons_dualaction.ctl"/>
			<Item Name="hmi_joe_johnson.vi" Type="VI" URL="../HMI/hmi_joe_johnson.vi"/>
			<Item Name="hmi_peg_leg.vi" Type="VI" URL="../HMI/hmi_peg_leg.vi"/>
			<Item Name="hmi_cheesy_drive.vi" Type="VI" URL="../HMI/hmi_cheesy_drive.vi"/>
			<Item Name="hmi_halo_drive.vi" Type="VI" URL="../HMI/hmi_halo_drive.vi"/>
			<Item Name="hmi_drivetrain.vi" Type="VI" URL="../HMI/hmi_drivetrain.vi"/>
			<Item Name="hmi_roller.vi" Type="VI" URL="../HMI/hmi_roller.vi"/>
			<Item Name="hmi_gun.vi" Type="VI" URL="../HMI/hmi_gun.vi"/>
			<Item Name="hmi_scriptbuttons.vi" Type="VI" URL="../HMI/hmi_scriptbuttons.vi"/>
			<Item Name="Main_Task.vi" Type="VI" URL="../Main_Task.vi"/>
			<Item Name="controlbox_prototype.vi" Type="VI" URL="../HMI/controlbox_prototype.vi"/>
		</Item>
		<Item Name="scriptlib" Type="Folder">
			<Item Name="SET_JOE_JOHNSON.vi" Type="VI" URL="../script/scriptlib/SET_JOE_JOHNSON.vi"/>
			<Item Name="SET_PEG_LEG.vi" Type="VI" URL="../script/scriptlib/SET_PEG_LEG.vi"/>
			<Item Name="STOPALL.vi" Type="VI" URL="../script/scriptlib/STOPALL.vi"/>
			<Item Name="TEMPLATE.vi" Type="VI" URL="../script/scriptlib/TEMPLATE.vi"/>
			<Item Name="WAIT.vi" Type="VI" URL="../script/scriptlib/WAIT.vi"/>
			<Item Name="WHEN.vi" Type="VI" URL="../script/scriptlib/WHEN.vi"/>
			<Item Name="RESET_SENSOR.vi" Type="VI" URL="../script/scriptlib/RESET_SENSOR.vi"/>
			<Item Name="DRIVE_STRAIGHT.vi" Type="VI" URL="../script/scriptlib/DRIVE_STRAIGHT.vi"/>
			<Item Name="FIRE.vi" Type="VI" URL="../script/scriptlib/FIRE.vi"/>
			<Item Name="SPINUPGUN.vi" Type="VI" URL="../script/scriptlib/SPINUPGUN.vi"/>
			<Item Name="DEBUG_VERBOSE.vi" Type="VI" URL="../script/scriptlib/DEBUG_VERBOSE.vi"/>
			<Item Name="SUCK.vi" Type="VI" URL="../script/scriptlib/SUCK.vi"/>
			<Item Name="NOSUCK.vi" Type="VI" URL="../script/scriptlib/NOSUCK.vi"/>
			<Item Name="BLOW.vi" Type="VI" URL="../script/scriptlib/BLOW.vi"/>
			<Item Name="WAIT_FOR_CAMERA.vi" Type="VI" URL="../script/scriptlib/WAIT_FOR_CAMERA.vi"/>
			<Item Name="FIRE_WHEN_READY.vi" Type="VI" URL="../script/scriptlib/FIRE_WHEN_READY.vi"/>
			<Item Name="SET_FIRE_CUSTOM.vi" Type="VI" URL="../script/scriptlib/SET_FIRE_CUSTOM.vi"/>
			<Item Name="SPINDOWNGUN.vi" Type="VI" URL="../script/scriptlib/SPINDOWNGUN.vi"/>
			<Item Name="SHIFT_UP.vi" Type="VI" URL="../script/scriptlib/SHIFT_UP.vi"/>
			<Item Name="SHIFT_DN.vi" Type="VI" URL="../script/scriptlib/SHIFT_DN.vi"/>
			<Item Name="driveStop.vi" Type="VI" URL="../script/scriptlib/driveStop.vi"/>
			<Item Name="DRIVE_STOP.vi" Type="VI" URL="../script/scriptlib/DRIVE_STOP.vi"/>
			<Item Name="SET_FIRE_PRESET.vi" Type="VI" URL="../script/scriptlib/SET_FIRE_PRESET.vi"/>
			<Item Name="driveStraight.vi" Type="VI" URL="../script/scriptlib/driveStraight.vi"/>
			<Item Name="DRIVE_TURN.vi" Type="VI" URL="../script/scriptlib/DRIVE_TURN.vi"/>
			<Item Name="DRIVE_HDG_TARGET.vi" Type="VI" URL="../script/scriptlib/DRIVE_HDG_TARGET.vi"/>
			<Item Name="driveTurn.vi" Type="VI" URL="../script/scriptlib/driveTurn.vi"/>
			<Item Name="DRIVE_SIMPLE.vi" Type="VI" URL="../script/scriptlib/DRIVE_SIMPLE.vi"/>
			<Item Name="DRIVE_RESET_ENCODERS.vi" Type="VI" URL="../script/scriptlib/DRIVE_RESET_ENCODERS.vi"/>
			<Item Name="driveSimple.vi" Type="VI" URL="../script/scriptlib/driveSimple.vi"/>
			<Item Name="driveHold.vi" Type="VI" URL="../script/scriptlib/driveHold.vi"/>
			<Item Name="DRIVE_HOLD.vi" Type="VI" URL="../script/scriptlib/DRIVE_HOLD.vi"/>
			<Item Name="WAIT_FOR_DATA.vi" Type="VI" URL="../script/scriptlib/WAIT_FOR_DATA.vi"/>
			<Item Name="DRIVE_POWER.vi" Type="VI" URL="../script/scriptlib/DRIVE_POWER.vi"/>
			<Item Name="drivePower.vi" Type="VI" URL="../script/scriptlib/drivePower.vi"/>
			<Item Name="DRIVE_STRAIGHT_CAM.vi" Type="VI" URL="../script/scriptlib/DRIVE_STRAIGHT_CAM.vi"/>
			<Item Name="FIRE_MULTIPLE.vi" Type="VI" URL="../script/scriptlib/FIRE_MULTIPLE.vi"/>
		</Item>
		<Item Name="roller" Type="Folder">
			<Item Name="roller.vi" Type="VI" URL="../roller/roller.vi"/>
			<Item Name="roller_output_state.ctl" Type="VI" URL="../roller/roller_output_state.ctl"/>
			<Item Name="roller_drive_relay.vi" Type="VI" URL="../roller/roller_drive_relay.vi"/>
			<Item Name="roller_user_state.ctl" Type="VI" URL="../roller/roller_user_state.ctl"/>
			<Item Name="roller_user_state_store.vi" Type="VI" URL="../roller/roller_user_state_store.vi"/>
			<Item Name="roller_internal_state.ctl" Type="VI" URL="../roller/roller_internal_state.ctl"/>
			<Item Name="roller_create.vi" Type="VI" URL="../roller/roller_create.vi"/>
			<Item Name="roller_map_button_to_state.vi" Type="VI" URL="../roller/roller_map_button_to_state.vi"/>
			<Item Name="roller_control_data_out.ctl" Type="VI" URL="../roller/roller_control_data_out.ctl"/>
			<Item Name="roller_control_data_in.ctl" Type="VI" URL="../roller/roller_control_data_in.ctl"/>
			<Item Name="roller_drive_motor.vi" Type="VI" URL="../roller/roller_drive_motor.vi"/>
			<Item Name="roller_globals.vi" Type="VI" URL="../roller/roller_globals.vi"/>
			<Item Name="roller_map_user_to_output_state.vi" Type="VI" URL="../roller/roller_map_user_to_output_state.vi"/>
		</Item>
		<Item Name="gun" Type="Folder">
			<Item Name="gun_rt.vi" Type="VI" URL="../gun/gun_rt.vi"/>
			<Item Name="gun_const.vi" Type="VI" URL="../gun/gun_const.vi"/>
			<Item Name="gun_reload_conf.vi" Type="VI" URL="../gun/gun_reload_conf.vi"/>
			<Item Name="gun_speed_control P2ID.vi" Type="VI" URL="../gun/gun_speed_control P2ID.vi"/>
			<Item Name="gun_const_t.ctl" Type="VI" URL="../gun/gun_const_t.ctl"/>
			<Item Name="gun_turret_input_scale.vi" Type="VI" URL="../gun/gun_turret_input_scale.vi"/>
			<Item Name="gun_turret_aim_state_T.ctl" Type="VI" URL="../gun/gun_turret_aim_state_T.ctl"/>
			<Item Name="gun_overide_data_store.vi" Type="VI" URL="../gun/gun_overide_data_store.vi"/>
			<Item Name="gun_tracking_data_store.vi" Type="VI" URL="../gun/gun_tracking_data_store.vi"/>
			<Item Name="gun_tracking_state_t.ctl" Type="VI" URL="../gun/gun_tracking_state_t.ctl"/>
			<Item Name="gun_vector.ctl" Type="VI" URL="../gun/gun_vector.ctl"/>
			<Item Name="gun_turret_prediction.vi" Type="VI" URL="../gun/gun_turret_prediction.vi"/>
			<Item Name="gun_coordinate.ctl" Type="VI" URL="../gun/gun_coordinate.ctl"/>
			<Item Name="vector_vect2cord.vi" Type="VI" URL="../gun/vector_vect2cord.vi"/>
			<Item Name="vector_cord2vect.vi" Type="VI" URL="../gun/vector_cord2vect.vi"/>
			<Item Name="gun_turret_lookup_preset_pos.vi" Type="VI" URL="../gun/gun_turret_lookup_preset_pos.vi"/>
			<Item Name="gun_preset_pos_t.ctl" Type="VI" URL="../gun/gun_preset_pos_t.ctl"/>
			<Item Name="gun_lookup_speed.vi" Type="VI" URL="../gun/gun_lookup_speed.vi"/>
			<Item Name="gun_rt_fast_downstream_datastore.vi" Type="VI" URL="../gun/gun_rt_fast_downstream_datastore.vi"/>
			<Item Name="gun_rt_fast_upstream_datastore.vi" Type="VI" URL="../gun/gun_rt_fast_upstream_datastore.vi"/>
			<Item Name="gun_rt_slow_downstream_datastore.vi" Type="VI" URL="../gun/gun_rt_slow_downstream_datastore.vi"/>
			<Item Name="gun_rt_slow_upstream_datastore.vi" Type="VI" URL="../gun/gun_rt_slow_upstream_datastore.vi"/>
			<Item Name="gun_rt_fast_downstream_data.ctl" Type="VI" URL="../gun/gun_rt_fast_downstream_data.ctl"/>
			<Item Name="gun_rt_fast_upstream_data.ctl" Type="VI" URL="../gun/gun_rt_fast_upstream_data.ctl"/>
			<Item Name="gun_rt_slow_downstream_data.ctl" Type="VI" URL="../gun/gun_rt_slow_downstream_data.ctl"/>
			<Item Name="gun_rt_slow_upstream_data.ctl" Type="VI" URL="../gun/gun_rt_slow_upstream_data.ctl"/>
			<Item Name="gun_create.vi" Type="VI" URL="../gun/gun_create.vi"/>
			<Item Name="gun_tracking_mode_store.vi" Type="VI" URL="../gun/gun_tracking_mode_store.vi"/>
			<Item Name="gun_tracking_mode.ctl" Type="VI" URL="../gun/gun_tracking_mode.ctl"/>
			<Item Name="gun_motor_state.ctl" Type="VI" URL="../gun/gun_motor_state.ctl"/>
			<Item Name="gun_map_mode_to_preset.vi" Type="VI" URL="../gun/gun_map_mode_to_preset.vi"/>
			<Item Name="gun_speed_mode_datastore.vi" Type="VI" URL="../gun/gun_speed_mode_datastore.vi"/>
			<Item Name="gun_speed_override_datastore.vi" Type="VI" URL="../gun/gun_speed_override_datastore.vi"/>
			<Item Name="gun_preset_bundle_t.ctl" Type="VI" URL="../gun/gun_preset_bundle_t.ctl"/>
			<Item Name="gain_sched_const.ctl" Type="VI" URL="../common/gain_sched_const.ctl"/>
			<Item Name="cam_track.vi" Type="VI" URL="../gun/cam_track.vi"/>
			<Item Name="gun_lock_store.vi" Type="VI" URL="../gun/gun_lock_store.vi"/>
			<Item Name="gun_speed_control P2IDv2.vi" Type="VI" URL="../gun/gun_speed_control P2IDv2.vi"/>
			<Item Name="gun_speed_control_feed_forward.vi" Type="VI" URL="../gun/gun_speed_control_feed_forward.vi"/>
			<Item Name="gun_speed_feed_forward.vi" Type="VI" URL="../gun/gun_speed_feed_forward.vi"/>
			<Item Name="gun_auton_custom_shot.vi" Type="VI" URL="../gun/gun_auton_custom_shot.vi"/>
			<Item Name="gun.vi" Type="VI" URL="../gun/gun.vi"/>
			<Item Name="gun_shot_param.ctl" Type="VI" URL="../gun/gun_shot_param.ctl"/>
			<Item Name="gun_fir_averaging.vi" Type="VI" URL="../gun/gun_fir_averaging.vi"/>
			<Item Name="gun_turret_man_ovr.vi" Type="VI" URL="../gun/gun_turret_man_ovr.vi"/>
		</Item>
		<Item Name="lights" Type="Folder">
			<Item Name="ligits.vi" Type="VI" URL="../lighting/ligits.vi"/>
			<Item Name="lights_create.vi" Type="VI" URL="../lighting/lights_create.vi"/>
			<Item Name="light_clock_data.vi" Type="VI" URL="../lighting/light_clock_data.vi"/>
			<Item Name="lights_led_mode.ctl" Type="VI" URL="../lighting/lights_led_mode.ctl"/>
			<Item Name="lights_relay_data.vi" Type="VI" URL="../lighting/lights_relay_data.vi"/>
			<Item Name="roller_read_sws.vi" Type="VI" URL="../roller/roller_read_sws.vi"/>
		</Item>
		<Item Name="signals" Type="Folder">
			<Item Name="SignalAction.ctl" Type="VI" URL="../signals/SignalAction.ctl"/>
			<Item Name="Signal.ctl" Type="VI" URL="../signals/Signal.ctl"/>
			<Item Name="SignalRegistry.vi" Type="VI" URL="../signals/SignalRegistry.vi"/>
			<Item Name="Callback_Roller_Fire.vi" Type="VI" URL="../signals/callbacks/Callback_Roller_Fire.vi"/>
			<Item Name="Callback_Gun_Fire.vi" Type="VI" URL="../signals/callbacks/Callback_Gun_Fire.vi"/>
			<Item Name="SignalManager.vi" Type="VI" URL="../signals/SignalManager.vi"/>
			<Item Name="SendSignal.vi" Type="VI" URL="../signals/SendSignal.vi"/>
			<Item Name="SignalTrap.vi" Type="VI" URL="../signals/SignalTrap.vi"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Normalized Range Compare.vi" Type="VI" URL="../2012vision/Normalized Range Compare.vi"/>
			<Item Name="Compute Distance.vi" Type="VI" URL="../2012vision/Compute Distance.vi"/>
			<Item Name="RT Overlay Helper.vi" Type="VI" URL="../2012vision/RT Overlay Helper.vi"/>
			<Item Name="Draw Filled Rect.vi" Type="VI" URL="../2012vision/Draw Filled Rect.vi"/>
			<Item Name="Side Angle Calculation.vi" Type="VI" URL="../2012vision/Side Angle Calculation.vi"/>
			<Item Name="mathArcadeDrive.vi" Type="VI" URL="../script/scriptlib/mathArcadeDrive.vi"/>
			<Item Name="HiTechnic Compass.lvlib" Type="Library" URL="../../../../../Program Files (x86)/National Instruments/LabVIEW 2011/examples/FRC/I2C/HiTechnic Compass/Driver/HiTechnic Compass.lvlib"/>
			<Item Name="Camera Data State.ctl" Type="VI" URL="../2012vision/Camera Data State.ctl"/>
			<Item Name="dashboard_return_data.ctl" Type="VI" URL="../dashboard/dashboard_return_data.ctl"/>
			<Item Name="Camera Constants.vi" Type="VI" URL="../2012vision/Camera Constants.vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="../../../../../Program Files (x86)/National Instruments/LabVIEW 2011/resource/lvanlys.dll"/>
			<Item Name="hmi_store_data.vi" Type="VI" URL="../HMI/hmi_store_data.vi"/>
			<Item Name="gun_speed_control.vi" Type="VI" URL="../gun/gun_speed_control.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Source[0].itemID" Type="Str">{4BCB8199-A44F-46B3-91D3-BB147C4DCB06}</Property>
